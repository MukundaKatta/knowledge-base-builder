"""FastAPI application for knowledge-base-builder."""
...
app = FastAPI(title="knowledge-base-builder", version="0.1.0", description="knowledge-base-builder API")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "knowledge-base-builder", "version": "0.1.0"}
...
async def process(req: ProcessRequest):
    ...
    try:
        ...
        resp = ProcessResponse(success=True, result=result, processing_time_ms=round(elapsed, 2),
                              metadata={"service": "knowledge-base-builder", "input_length": len(req.input)})
...
@app.get("/status")
def status():
    return {"service": "knowledge-base-builder", "version": "0.1.0", "ready": True,
